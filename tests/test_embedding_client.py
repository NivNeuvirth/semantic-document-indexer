...
def test_init_success():
    ...
    with patch("src.embedding_client.genai.Client"): # Note: file imports genai
...
def test_get_embedding_success():
    ...
    with patch("src.embedding_client.genai.Client") as MockGenAI:
        # Setup mock
...
def test_get_embedding_empty_text():
    ...
    with patch("src.embedding_client.genai.Client"):
        client = EmbeddingClient()
